...
export const es: TranslationKeys = {
  ...
  home: {
    ...
    subscribeCta: 'Suscríbete a Prompt Squad Pro para desbloquear todo y crear mascotas personalizadas con habilidades por 3,99€ / mes',
  ...
  profile: {
    ...
    geminiDesc: 'Rápido y eficiente',
    openai: 'OpenAI GPT',
    openaiDesc: 'Más capaz',
    account: 'Cuenta',
