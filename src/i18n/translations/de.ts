...
export const de: TranslationKeys = {
  ...
  home: {
    ...
    subscribeCta: 'Abonniere Prompt Squad Pro und schalte alle frei sowie erstelle benutzerdefinierte Maskottchen mit Fähigkeiten für 3,99€ / Monat',
  ...
  profile: {
    ...
    geminiDesc: 'Schnell & effizient',
    openai: 'OpenAI GPT',
    openaiDesc: 'Am leistungsfähigsten',
    account: 'Konto',
    signOut: 'Abmelden',
    version: 'Version',
  },
