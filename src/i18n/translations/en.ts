export const en = {
  ...
  home: {
    ...
    showAll: 'Show all',
    subscribeCta: 'Subscribe to Prompt Squad pro to unlock all and create custom mascots with skills for 9,99€ / month',
    createCustom: 'Create custom',
    addMoreAgents: 'Add more',
  },
  ...
  profile: {
    ...
    auto: 'Auto',
    autoDesc: 'Best model for the task',
    gemini: 'Google Gemini 3.1 Pro',
    geminiDesc: 'Google frontier multimodal (Pro / Flash)',
    openai: 'OpenAI GPT-5.4',
    openaiDesc: 'OpenAI flagship for reasoning & coding',
    perplexity: 'Perplexity Sonar Reasoning Pro',
    perplexityDesc: 'Web-grounded research',
    grok: 'xAI Grok 4.1',
