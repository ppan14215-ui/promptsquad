export const en = {
  ...
  home: {
    ...
    showAll: 'Show all',
    subscribeCta: 'Subscribe to Prompt Squad pro to unlock all and create custom mascots with skills for 3,99€ / month',
  ...
  profile: {
    ...
    geminiDesc: 'Fast & efficient',
    openai: 'OpenAI GPT',
    openaiDesc: 'Most capable',
    account: 'Account',
    signOut: 'Sign out',
    version: 'Version',
  },
